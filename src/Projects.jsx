...
const projectsMeta = [
  {
    key: 'AOOP_Project',
    name: 'AOOP_Project',
    description: 'a banking system that thinks in objects and forgets withdrawals.',
    tools: 'Java, IntelliJ',
  ...
  },
  {
    key: 'K00300249',
    name: 'K00300249',
    description: 'a surreal personal site prototype that mutates with every scroll.',
    tools: 'HTML, CSS, JS',
  ...
  },
  {
    key: 'OOP_Project',
    name: 'OOP_Project',
    description: 'a recursive object model that can’t stop classifying itself.',
  ...
  },
  {
    key: 'MC_TRAILER',
    name: 'MC_TRAILER',
    description: 'a haunting trailer for a media concept that never truly aired.',
